...
from inventory.serializers import CategorySerializer, SupplierSerializer, ImagesUploadSerializer, ProductSerializer, \
    InventorySerializer, CustomerSerializer, OrderSerializer, TransactionSerializer, LocationSerializer, \
    OnlineBuyerSerializer, ShipmentsSerializer, EmployeesSerializer
