...
class Product(models.Model):
    ...
    image = models.ForeignKey(ImagesUpload, on_delete=models.SET_DEFAULT, default=get_default_image, max_length=100,
...
# track the movement of inventory, such as when items are received from suppliers, sold to customers, or transferred
# between locations.
